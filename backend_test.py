...
# Configuration
PREVIEW_BASE_URL = "https://slush-media-fix.preview.emergentagent.com/api"  # Preview environment
    ...
    def test_custom_domain_login(self):
        ...
        try:
            ...
            test_origins = [
                ...
                "https://slush-media-fix.preview.emergentagent.com"
            ]
...
def main():
    ...
    preview_url = "https://slush-media-fix.preview.emergentagent.com/api"
