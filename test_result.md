...
at https://bugfix-intl-tour.preview.emergentagent.com/api/admin/translations/da
```
...
1. Log in with admin credentials at https://bugfix-intl-tour.preview.emergentagent.com/login
