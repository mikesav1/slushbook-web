...
import { FaHome, FaBook, FaBoxOpen, FaShoppingCart, FaHeart, FaSearch, FaCog, FaMagic, FaPlus, FaSignOutAlt, FaSeedling, FaLink, FaAd, FaLightbulb } from "react-icons/fa";
import "@/App.css";
...
const Navigation = () => {
  ...
  const navItems = [
    ...
    { path: "/tips", icon: FaLightbulb, label: "Tips & Tricks" },
