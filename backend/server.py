...
async def login(request: LoginRequest, response: Response, http_request: Request):
    ...
    return {
        ...
        "user": {
            ...
            "language": user_doc.get("language_preference", user_doc.get("language", "da")),  # Read from language_preference first - FIX: Changed from "dk" to "da"
...
async def get_recipes(
    ...
    lang: str = "da"  # Language code for translations
):
...
# =============================================================================
# SIMPLE TRANSLATION EDITOR ENDPOINTS (Must be before parameterized routes)
# =============================================================================
...
async def get_translations_for_editor(
    ...
    Returns: {
        ...
        "target_language": "de",
        "translations": [
            {"key": "common.save", "master": "Gem", "translation": "Speichern"},
            ...
        ]
    }
    """
    ...
    # Validate language
    valid_languages = ['de', 'fr', 'en', 'en_us']
    ...
    try:
        pairs = get_translation_pairs(master_lang='da', target_lang=language)
        ...
        translations = [
            ...
            for key, master_text, target_text in pairs
        ]
...
async def update_translations_from_editor(
    ...
    try:
        ...
        target_file = locales_dir / f"{language}.json"
        
        save_translation_file(target_file, translations)
        
        logger.info(f"Admin {user.email} updated {len(translations)} translations for language: {language}")
